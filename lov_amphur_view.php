...
$lov_amphur_view = NULL; // Initialize page object first

class clov_amphur_view extends clov_amphur {
	...
	// Page object name
	var $PageObjName = 'lov_amphur_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["AMPHUR_ID"] <> "") {
			$this->RecKey["AMPHUR_ID"] = $_GET["AMPHUR_ID"];
			$KeyUrl .= "&amp;AMPHUR_ID=" . urlencode($this->RecKey["AMPHUR_ID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["AMPHUR_ID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["AMPHUR_ID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["AMPHUR_ID"] <> "") {
				...
				$this->RecKey["AMPHUR_ID"] = $this->AMPHUR_ID->QueryStringValue;
			} elseif (@$_POST["AMPHUR_ID"] <> "") {
				$this->AMPHUR_ID->setFormValue($_POST["AMPHUR_ID"]);
				$this->RecKey["AMPHUR_ID"] = $this->AMPHUR_ID->FormValue;
			} else {
				$sReturnUrl = "lov_amphur_list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "lov_amphur_list.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "lov_amphur_list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($lov_amphur_view)) $lov_amphur_view = new clov_amphur_view();

// Page init
$lov_amphur_view->Page_Init();

// Page main
$lov_amphur_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$lov_amphur_view->Page_Render();
?>
...
var CurrentForm = flov_amphurview = new ew_Form("flov_amphurview", "view");

// Form_CustomValidate event
flov_amphurview.Form_CustomValidate = 
...
flov_amphurview.ValidateRequired = true;
<?php } else { ?>
flov_amphurview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
flov_amphurview.Lists["x_PROVINCE_ID"] = {"LinkField":"x_PROVINCE_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_PROVINCE_NAME","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php } ?>
<?php $lov_amphur_view->ExportOptions->Render("body") ?>
<?php
	foreach ($lov_amphur_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($lov_amphur->Export == "") { ?>
...
<?php } ?>
<?php $lov_amphur_view->ShowPageHeader(); ?>
<?php
$lov_amphur_view->ShowMessage();
?>
<form name="flov_amphurview" id="flov_amphurview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($lov_amphur_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $lov_amphur_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="lov_amphur">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($lov_amphur->AMPHUR_ID->Visible) { // AMPHUR_ID ?>
	<tr id="r_AMPHUR_ID">
		<td><span id="elh_lov_amphur_AMPHUR_ID"><?php echo $lov_amphur->AMPHUR_ID->FldCaption() ?></span></td>
...
<?php echo $lov_amphur->AMPHUR_ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lov_amphur->AMPHUR_CODE->Visible) { // AMPHUR_CODE ?>
	<tr id="r_AMPHUR_CODE">
		<td><span id="elh_lov_amphur_AMPHUR_CODE"><?php echo $lov_amphur->AMPHUR_CODE->FldCaption() ?></span></td>
...
<?php echo $lov_amphur->AMPHUR_CODE->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lov_amphur->PROVINCE_ID->Visible) { // PROVINCE_ID ?>
	<tr id="r_PROVINCE_ID">
		<td><span id="elh_lov_amphur_PROVINCE_ID"><?php echo $lov_amphur->PROVINCE_ID->FldCaption() ?></span></td>
...
<?php echo $lov_amphur->PROVINCE_ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lov_amphur->AMPHUR_NAME->Visible) { // AMPHUR_NAME ?>
	<tr id="r_AMPHUR_NAME">
		<td><span id="elh_lov_amphur_AMPHUR_NAME"><?php echo $lov_amphur->AMPHUR_NAME->FldCaption() ?></span></td>
...
<?php echo $lov_amphur->AMPHUR_NAME->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lov_amphur->AMPER_NAME_EN->Visible) { // AMPER_NAME_EN ?>
	<tr id="r_AMPER_NAME_EN">
		<td><span id="elh_lov_amphur_AMPER_NAME_EN"><?php echo $lov_amphur->AMPER_NAME_EN->FldCaption() ?></span></td>
...
<?php echo $lov_amphur->AMPER_NAME_EN->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($lov_amphur->Export == "") { ?>
<script type="text/javascript">
flov_amphurview.Init();
</script>
<?php } ?>
<?php
$lov_amphur_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($lov_amphur->Export == "") { ?>
...
<?php
$lov_amphur_view->Page_Terminate();
?>
