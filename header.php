...
<script type="text/javascript" src="<?php echo $EW_RELATIVE_PATH ?>tinymce/tinymce.min.js"></script>
...
if (currentUsername!="") {
$(".ewMenu").prepend('<div id="loggedinUser" style="height: 50px;line-height: 50px;color: #FFFFFF;font-size: 12px;z-index: 999;background-color: #000;font-weight: bold;margin-top: 0px;margin-right: auto;margin-bottom: 0px;margin-left: auto;padding-right: 10px;padding-left: 10px;float: left;padding-top: 0px;padding-bottom: 0px;position: relative;">Login as : <strong>'+currentUsername+'</strong></div>');
}
});
</script>
<?php } ?>
<link rel="shortcut icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("Pixture-Ware-House-OpenBox-2.ico") ?>"><link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("Pixture-Ware-House-OpenBox-2.ico") ?>">
