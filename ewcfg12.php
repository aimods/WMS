...
define("EW_PROJECT_NAME", "nBOT", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{B1D96CD0-2849-4DC1-8F87-20EC273F9356}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'b6EFj2jXJ3spNDWc', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/nbot.css", TRUE); // Project stylesheet file name
...
define('EW_USE_DOM_XML', ((!function_exists('xml_parser_create') && class_exists("DOMDocument")) || TRUE), TRUE);
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "nBOT", "pass" => "KyyH7T23WqoE54ab", "db" => "nBOT", "qs" => "`", "qe" => "`");
...
define("EW_ADMIN_PASSWORD", "ly,4kKIN!@#456", TRUE); // Administrator password
...
define("EW_USER_TABLE", "`main_User`", TRUE);
define("EW_USER_NAME_FILTER", "(`u_LoginName` = '%u')", TRUE);
define("EW_USER_ID_FILTER", "", TRUE);
define("EW_USER_EMAIL_FILTER", "(`u_Email` = '%e')", TRUE);
define("EW_USER_ACTIVATE_FILTER", "(`u_Status` = 1)", TRUE);
define("EW_USER_PROFILE_FIELD_NAME", "u_Profile", TRUE);
...
// Email
define("EW_SMTP_SERVER", "smtp.mailgun.org", TRUE); // SMTP server
define("EW_SMTP_SERVER_PORT", 465, TRUE); // SMTP server port
define("EW_SMTP_SECURE_OPTION", "tls", TRUE);
define("EW_SMTP_SERVER_USERNAME", "nbot@invoice.in.th", TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", "ly,4kKIN!@#456", TRUE); // SMTP server password
define("EW_SENDER_EMAIL", "noreply@invoice.in.th", TRUE); // Sender email address
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "pdf,xls,xlsx,doc,docx,jpg,png,jpeg", TRUE); // Allowed file extensions
...
// Use css flip
$EW_CSS_FLIP = FALSE;
$EW_RTL_LANGUAGES = array("ar", "he", "ug", "ur");
