...
$bot_SendMSG_view = NULL; // Initialize page object first

class cbot_SendMSG_view extends cbot_SendMSG {
	...
	// Page object name
	var $PageObjName = 'bot_SendMSG_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["sm_ID"] <> "") {
			$this->RecKey["sm_ID"] = $_GET["sm_ID"];
			$KeyUrl .= "&amp;sm_ID=" . urlencode($this->RecKey["sm_ID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["sm_ID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["sm_ID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["sm_ID"] <> "") {
				...
				$this->RecKey["sm_ID"] = $this->sm_ID->QueryStringValue;
			} elseif (@$_POST["sm_ID"] <> "") {
				$this->sm_ID->setFormValue($_POST["sm_ID"]);
				$this->RecKey["sm_ID"] = $this->sm_ID->FormValue;
			} else {
				$sReturnUrl = "bot_sendmsg_list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "bot_sendmsg_list.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "bot_sendmsg_list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($bot_SendMSG_view)) $bot_SendMSG_view = new cbot_SendMSG_view();

// Page init
$bot_SendMSG_view->Page_Init();

// Page main
$bot_SendMSG_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$bot_SendMSG_view->Page_Render();
?>
...
var CurrentForm = fbot_SendMSGview = new ew_Form("fbot_SendMSGview", "view");

// Form_CustomValidate event
fbot_SendMSGview.Form_CustomValidate = 
...
fbot_SendMSGview.ValidateRequired = true;
<?php } else { ?>
fbot_SendMSGview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fbot_SendMSGview.Lists["x_u_sendTo"] = {"LinkField":"x_u_UUID","Ajax":true,"AutoFill":false,"DisplayFields":["x_u_BillName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fbot_SendMSGview.Lists["x_u_TextType"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fbot_SendMSGview.Lists["x_u_TextType"].Options = <?php echo json_encode($bot_SendMSG->u_TextType->Options()) ?>;
fbot_SendMSGview.Lists["x_u_Status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fbot_SendMSGview.Lists["x_u_Status"].Options = <?php echo json_encode($bot_SendMSG->u_Status->Options()) ?>;
...
<?php } ?>
<?php $bot_SendMSG_view->ExportOptions->Render("body") ?>
<?php
	foreach ($bot_SendMSG_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($bot_SendMSG->Export == "") { ?>
...
<?php } ?>
<?php $bot_SendMSG_view->ShowPageHeader(); ?>
<?php
$bot_SendMSG_view->ShowMessage();
?>
<form name="fbot_SendMSGview" id="fbot_SendMSGview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($bot_SendMSG_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $bot_SendMSG_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="bot_SendMSG">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($bot_SendMSG->sm_ID->Visible) { // sm_ID ?>
	<tr id="r_sm_ID">
		<td><span id="elh_bot_SendMSG_sm_ID"><?php echo $bot_SendMSG->sm_ID->FldCaption() ?></span></td>
		<td data-name="sm_ID"<?php echo $bot_SendMSG->sm_ID->CellAttributes() ?>>
<span id="el_bot_SendMSG_sm_ID">
<span<?php echo $bot_SendMSG->sm_ID->ViewAttributes() ?>>
<?php echo $bot_SendMSG->sm_ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($bot_SendMSG->u_ID->Visible) { // u_ID ?>
	<tr id="r_u_ID">
		<td><span id="elh_bot_SendMSG_u_ID"><?php echo $bot_SendMSG->u_ID->FldCaption() ?></span></td>
...
<?php echo $bot_SendMSG->u_ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($bot_SendMSG->u_sendTo->Visible) { // u_sendTo ?>
	<tr id="r_u_sendTo">
		<td><span id="elh_bot_SendMSG_u_sendTo"><?php echo $bot_SendMSG->u_sendTo->FldCaption() ?></span></td>
...
<?php echo $bot_SendMSG->u_sendTo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($bot_SendMSG->u_TextType->Visible) { // u_TextType ?>
	<tr id="r_u_TextType">
		<td><span id="elh_bot_SendMSG_u_TextType"><?php echo $bot_SendMSG->u_TextType->FldCaption() ?></span></td>
...
<?php echo $bot_SendMSG->u_TextType->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($bot_SendMSG->u_sendText->Visible) { // u_sendText ?>
	<tr id="r_u_sendText">
		<td><span id="elh_bot_SendMSG_u_sendText"><?php echo $bot_SendMSG->u_sendText->FldCaption() ?></span></td>
		<td data-name="u_sendText"<?php echo $bot_SendMSG->u_sendText->CellAttributes() ?>>
<span id="el_bot_SendMSG_u_sendText">
<span<?php echo $bot_SendMSG->u_sendText->ViewAttributes() ?>>
<?php echo $bot_SendMSG->u_sendText->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($bot_SendMSG->u_sendSchedule->Visible) { // u_sendSchedule ?>
	<tr id="r_u_sendSchedule">
		<td><span id="elh_bot_SendMSG_u_sendSchedule"><?php echo $bot_SendMSG->u_sendSchedule->FldCaption() ?></span></td>
...
<?php echo $bot_SendMSG->u_sendSchedule->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($bot_SendMSG->u_Status->Visible) { // u_Status ?>
	<tr id="r_u_Status">
		<td><span id="elh_bot_SendMSG_u_Status"><?php echo $bot_SendMSG->u_Status->FldCaption() ?></span></td>
...
<?php echo $bot_SendMSG->u_Status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($bot_SendMSG->u_Create->Visible) { // u_Create ?>
	<tr id="r_u_Create">
		<td><span id="elh_bot_SendMSG_u_Create"><?php echo $bot_SendMSG->u_Create->FldCaption() ?></span></td>
		<td data-name="u_Create"<?php echo $bot_SendMSG->u_Create->CellAttributes() ?>>
<span id="el_bot_SendMSG_u_Create">
<span<?php echo $bot_SendMSG->u_Create->ViewAttributes() ?>>
<?php echo $bot_SendMSG->u_Create->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($bot_SendMSG->u_Sent->Visible) { // u_Sent ?>
	<tr id="r_u_Sent">
		<td><span id="elh_bot_SendMSG_u_Sent"><?php echo $bot_SendMSG->u_Sent->FldCaption() ?></span></td>
...
<?php echo $bot_SendMSG->u_Sent->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($bot_SendMSG->Export == "") { ?>
<script type="text/javascript">
fbot_SendMSGview.Init();
</script>
<?php } ?>
<?php
$bot_SendMSG_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($bot_SendMSG->Export == "") { ?>
...
<?php
$bot_SendMSG_view->Page_Terminate();
?>
