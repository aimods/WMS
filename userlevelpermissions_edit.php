...
<?php include_once "userlevelpermissions_info.php" ?>
...
class cuserlevelpermissions_edit extends cuserlevelpermissions {
	...
	function Page_Main() {
		...
		if ($this->userlevelid->CurrentValue == "")
			$this->Page_Terminate("userlevelpermissions_list.php"); // Invalid key, return to list
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("userlevelpermissions_list.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "userlevelpermissions_list.php")
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, $this->AddMasterUrl("userlevelpermissions_list.php"), "", $this->TableVar, TRUE);
		$PageId = "edit";
