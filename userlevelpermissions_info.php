...
class cuserlevelpermissions extends cTable {
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "userlevelpermissions_list.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("userlevelpermissions_view.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("userlevelpermissions_view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "userlevelpermissions_add.php?" . $this->UrlParm($parm);
		else
			$url = "userlevelpermissions_add.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("userlevelpermissions_edit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("userlevelpermissions_add.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("userlevelpermissions_delete.php", $this->UrlParm());
	}
