...
class cuserlevelpermissions_delete extends cuserlevelpermissions {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("userlevelpermissions_list.php"); // Prevent SQL injection, return to list
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("userlevelpermissions_list.php"); // Return to list
			}
		}
	}
