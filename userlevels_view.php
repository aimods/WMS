	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["userlevelid"] <> "") {
				...
				$sReturnUrl = "userlevels_list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "userlevels_list.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "userlevels_list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
