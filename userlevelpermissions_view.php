	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["userlevelid"] <> "") {
				...
				$sReturnUrl = "userlevelpermissions_list.php"; // Return to list
			}
			if (@$_GET["_tablename"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "userlevelpermissions_list.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "userlevelpermissions_list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
