...
//
// Table class for lov_province
//
class clov_province extends cTable {
	var $PROVINCE_ID;
	var $PROVINCE_CODE;
	var $PROVINCE_NAME;
	...
	function __construct() {
		...
		$this->TableVar = 'lov_province';
		$this->TableName = 'lov_province';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`lov_province`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// PROVINCE_ID
		$this->PROVINCE_ID = new cField('lov_province', 'lov_province', 'x_PROVINCE_ID', 'PROVINCE_ID', '`PROVINCE_ID`', '`PROVINCE_ID`', 3, -1, FALSE, '`PROVINCE_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->PROVINCE_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['PROVINCE_ID'] = &$this->PROVINCE_ID;

		// PROVINCE_CODE
		$this->PROVINCE_CODE = new cField('lov_province', 'lov_province', 'x_PROVINCE_CODE', 'PROVINCE_CODE', '`PROVINCE_CODE`', '`PROVINCE_CODE`', 200, -1, FALSE, '`PROVINCE_CODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['PROVINCE_CODE'] = &$this->PROVINCE_CODE;

		// PROVINCE_NAME
		$this->PROVINCE_NAME = new cField('lov_province', 'lov_province', 'x_PROVINCE_NAME', 'PROVINCE_NAME', '`PROVINCE_NAME`', '`PROVINCE_NAME`', 200, -1, FALSE, '`PROVINCE_NAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['PROVINCE_NAME'] = &$this->PROVINCE_NAME;

		// PROVINCE_NAME_EN
		$this->PROVINCE_NAME_EN = new cField('lov_province', 'lov_province', 'x_PROVINCE_NAME_EN', 'PROVINCE_NAME_EN', '`PROVINCE_NAME_EN`', '`PROVINCE_NAME_EN`', 200, -1, FALSE, '`PROVINCE_NAME_EN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "lov_amphur") {
			$sDetailUrl = $GLOBALS["lov_amphur"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_PROVINCE_ID=" . urlencode($this->PROVINCE_ID->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "lov_province_list.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`lov_province`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("lov_province_view.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("lov_province_view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "lov_province_add.php?" . $this->UrlParm($parm);
		else
			$url = "lov_province_add.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("lov_province_edit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("lov_province_edit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("lov_province_add.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("lov_province_add.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("lov_province_delete.php", $this->UrlParm());
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			if ($isPost && isset($_POST["PROVINCE_ID"]))
				$arKeys[] = ew_StripSlashes($_POST["PROVINCE_ID"]);
			elseif (isset($_GET["PROVINCE_ID"]))
				$arKeys[] = ew_StripSlashes($_GET["PROVINCE_ID"]);
			else
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->PROVINCE_NAME->EditValue = $this->PROVINCE_NAME->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->PROVINCE_NAME->Exportable) $Doc->ExportCaption($this->PROVINCE_NAME);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->PROVINCE_NAME->Exportable) $Doc->ExportField($this->PROVINCE_NAME);
