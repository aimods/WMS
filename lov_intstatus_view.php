...
$lov_intStatus_view = NULL; // Initialize page object first

class clov_intStatus_view extends clov_intStatus {
	...
	// Page object name
	var $PageObjName = 'lov_intStatus_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["in_ID"] <> "") {
			$this->RecKey["in_ID"] = $_GET["in_ID"];
			$KeyUrl .= "&amp;in_ID=" . urlencode($this->RecKey["in_ID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["in_ID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["in_ID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["in_ID"] <> "") {
				...
				$this->RecKey["in_ID"] = $this->in_ID->QueryStringValue;
			} elseif (@$_POST["in_ID"] <> "") {
				$this->in_ID->setFormValue($_POST["in_ID"]);
				$this->RecKey["in_ID"] = $this->in_ID->FormValue;
			} else {
				$sReturnUrl = "lov_intstatus_list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "lov_intstatus_list.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "lov_intstatus_list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($lov_intStatus_view)) $lov_intStatus_view = new clov_intStatus_view();

// Page init
$lov_intStatus_view->Page_Init();

// Page main
$lov_intStatus_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$lov_intStatus_view->Page_Render();
?>
...
var CurrentForm = flov_intStatusview = new ew_Form("flov_intStatusview", "view");

// Form_CustomValidate event
flov_intStatusview.Form_CustomValidate = 
...
flov_intStatusview.ValidateRequired = true;
<?php } else { ?>
flov_intStatusview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
flov_intStatusview.Lists["x_in_isDeath"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
flov_intStatusview.Lists["x_in_isDeath"].Options = <?php echo json_encode($lov_intStatus->in_isDeath->Options()) ?>;
flov_intStatusview.Lists["x_in_isSale"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
flov_intStatusview.Lists["x_in_isSale"].Options = <?php echo json_encode($lov_intStatus->in_isSale->Options()) ?>;
...
<?php } ?>
<?php $lov_intStatus_view->ExportOptions->Render("body") ?>
<?php
	foreach ($lov_intStatus_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($lov_intStatus->Export == "") { ?>
...
<?php } ?>
<?php $lov_intStatus_view->ShowPageHeader(); ?>
<?php
$lov_intStatus_view->ShowMessage();
?>
<form name="flov_intStatusview" id="flov_intStatusview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($lov_intStatus_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $lov_intStatus_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="lov_intStatus">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($lov_intStatus->in_Name->Visible) { // in_Name ?>
	<tr id="r_in_Name">
		<td><span id="elh_lov_intStatus_in_Name"><?php echo $lov_intStatus->in_Name->FldCaption() ?></span></td>
...
<?php echo $lov_intStatus->in_Name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lov_intStatus->in_isDeath->Visible) { // in_isDeath ?>
	<tr id="r_in_isDeath">
		<td><span id="elh_lov_intStatus_in_isDeath"><?php echo $lov_intStatus->in_isDeath->FldCaption() ?></span></td>
...
<?php echo $lov_intStatus->in_isDeath->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lov_intStatus->in_isSale->Visible) { // in_isSale ?>
	<tr id="r_in_isSale">
		<td><span id="elh_lov_intStatus_in_isSale"><?php echo $lov_intStatus->in_isSale->FldCaption() ?></span></td>
...
<?php echo $lov_intStatus->in_isSale->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lov_intStatus->is_InternalUse->Visible) { // is_InternalUse ?>
	<tr id="r_is_InternalUse">
		<td><span id="elh_lov_intStatus_is_InternalUse"><?php echo $lov_intStatus->is_InternalUse->FldCaption() ?></span></td>
...
<?php echo $lov_intStatus->is_InternalUse->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lov_intStatus->in_Note->Visible) { // in_Note ?>
	<tr id="r_in_Note">
		<td><span id="elh_lov_intStatus_in_Note"><?php echo $lov_intStatus->in_Note->FldCaption() ?></span></td>
		<td data-name="in_Note"<?php echo $lov_intStatus->in_Note->CellAttributes() ?>>
<span id="el_lov_intStatus_in_Note">
<span<?php echo $lov_intStatus->in_Note->ViewAttributes() ?>>
<?php echo $lov_intStatus->in_Note->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($lov_intStatus->Export == "") { ?>
<script type="text/javascript">
flov_intStatusview.Init();
</script>
<?php } ?>
<?php
$lov_intStatus_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($lov_intStatus->Export == "") { ?>
...
<?php
$lov_intStatus_view->Page_Terminate();
?>
