...
<?php include_once "userlevels_info.php" ?>
...
class cuserlevels_edit extends cuserlevels {
	...
	function Page_Main() {
		...
		if ($this->userlevelid->CurrentValue == "")
			$this->Page_Terminate("userlevels_list.php"); // Invalid key, return to list
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("userlevels_list.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "userlevels_list.php")
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, $this->AddMasterUrl("userlevels_list.php"), "", $this->TableVar, TRUE);
		$PageId = "edit";
